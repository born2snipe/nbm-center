...
public class CompressedCatalogResourceEndpointTest extends ResourceTest {
    @Mock
    ...
    protected void setUpResources() throws Exception {
        resource = new CompressedCatalogResource(repository);
    ...
    @Test
    public void getCompressedCatalog() {
        assertNotNull(client().resource("/catalog.xml.gz").get(InputStream.class));
    }
}
